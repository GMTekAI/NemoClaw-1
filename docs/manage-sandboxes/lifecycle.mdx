...
The restart command force-restarts the gateway through the host-mediated path, waits for health, and checks or recovers the dashboard and agent forwards.
