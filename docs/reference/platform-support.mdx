...
For version highlights, refer to [Release Notes](../about/release-notes).
...
For the onboarding-time supported set without deferred rows, refer to [Prerequisites](../get-started/prerequisites#platforms).
